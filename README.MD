...
I configured the EC2 server, installed and configured Nginx, deployed the website files, configured the required Security Group ports, and connected the custom domain.
...
![Gift Heaven Architecture](./image.png)

## Deployment Process

### Step 1: Create EC2 Instance

I created an EC2 instance on AWS and used it as the server for hosting the Gift Heaven website.

### Step 2: Connect to EC2

I connected to the EC2 Linux server using SSH.
...
![Gift Heaven Website](https://raw.githubusercontent.com/Priticode/Gift-Heaven/main/giftoutput.png)